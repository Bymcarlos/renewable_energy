...
<!-- Icon Cards-->
  <div class="row">
    ...
    <div class="col-xl-4 col-sm-4 mb-3">
      <div class="card text-white badge-success o-hidden h-100">
        <div class="card-body">
          <div class="card-body-icon">
            <i class="fa fa-fw fa-table"></i>
          </div>
        ...
        <a class="card-footer text-white clearfix small z-1" href="{{ route('ratings.areas') }}">
    ...
    <div class="col-xl-4 col-sm-4 mb-3">
      <div class="card text-white badge-info o-hidden h-100">
        <div class="card-body">
          <div class="card-body-icon">
            <i class="fa fa-fw fa-table"></i>
          </div>
        ...
        <a class="card-footer text-white clearfix small z-1" href="{{ route('ratingreports.index') }}">
