        ...
        <table class="table table-bordered" width="100%" cellspacing="0">
            <tbody>
                <tr>
                    ...
                    <td width="30%">{{ $bench->areaComponent()->first()->component()->first()->title }}</td>
                </tr>
            </tbody>
        </table>
    </div>
                        ...
                        <table class="table table-bordered" width="100%" cellspacing="0">
                            <tbody>
                                @foreach($assessment->sheets()->get() as $sheet)
                                    ...
                                    <tr>
                                        <td class="col"><a href="{{ route('benches.reports.parameters.features',['bench'=>$bench->id,'sheet'=>$sheet->id]) }}">{{ $sheet->title }}</a>
                                        </td>
                                    </tr>
                                    @endif
                                @endforeach
